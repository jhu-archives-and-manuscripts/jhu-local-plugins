...
def add_restriction_to_record(record,
                              ...
                              end_date = '2020-01-01',
                              local_access_restriction_type = ["Deed of gift imposed", "Institutional policy imposed", "RestrictedSpecColl", "RestrictedCurApprSpecColl",
...
describe 'Managed Container restrictions' do
  ...
  it "returns information about restrictions in the jsonmodel" do
    ...
    restriction['local_access_restriction_type'].should eq(["Deed of gift imposed", "Institutional policy imposed", "RestrictedSpecColl", "RestrictedCurApprSpecColl",
                                                            "RestrictedFragileSpecColl", "InProcessSpecColl",
                                                            "ColdStorageBrbl"])
